...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student larsPetter = new Student("81223344557", "Lars-Petter", "Helland", "Informatikk");
        System.out.println();
        System.out.println(larsPetter);

        Ansatt petterLars = new Ansatt("86554433222", "Petter-Lars", "Olsen", "Rektor");
        System.out.println();
        ...
        System.out.println();
        System.out.println(personDAO.finnPersonMedFNr("81223344557"));
        System.out.println(personDAO.finnPersonMedFNr("86554433222"));
